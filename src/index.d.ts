...
declare class Cosmos {
  ...
  submit(child: any, txBody: any, broadCastMode?: BroadCastMode, fees?: any[], gas_limit?: number, timeoutConfig?: { timeoutHeight: number, timeoutIntervalCheck: number }): Promise<any>;
}
